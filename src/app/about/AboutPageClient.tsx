...
export default function AboutPageClient() {
  ...
  // FAQ данные для страницы "О клинике"
  const faqItems = [
    {
      question: "Сколько лет работает клиника Мастерская?",
      answer: "Клиника Мастерская работает уже более 15 лет, помогая людям преодолевать зависимости и возвращаться к здоровой жизни. За это время мы помогли более 1500 пациентам.",
      keywords: ["клиника Мастерская", "опыт работы", "история"]
    },
    {
      question: "Какие специалисты работают в клинике?",
      answer: "В нашей команде работают опытные врачи-наркологи, психотерапевты, психологи, остеопаты и другие специалисты. Общий стаж команды составляет более 100 лет.",
      keywords: ["специалисты", "врачи", "команда", "опыт"]
    },
    {
      question: "Есть ли у клиники лицензия?",
      answer: "Да, клиника имеет все необходимые лицензии и сертификаты для оказания медицинских услуг. Мы работаем в строгом соответствии с российским законодательством.",
      keywords: ["лицензия", "сертификаты", "законодательство"]
    },
    {
      question: "Где находится клиника?",
      answer: "Клиника расположена в Санкт-Петербурге по адресу ул. Заставская, 33л. Мы работаем круглосуточно и принимаем пациентов из всех районов города и области.",
      keywords: ["адрес", "Санкт-Петербург", "расположение", "районы"]
    },
    {
      question: "Какова успешность лечения в клинике?",
      answer: "По нашим данным, успешность лечения составляет 95%. Это достигается благодаря индивидуальному подходу, современным методикам и постоянной поддержке пациентов.",
      keywords: ["успешность лечения", "результаты", "методики", "поддержка"]
    },
    {
      question: "Работаете ли вы с тяжелыми случаями?",
      answer: "Да, мы работаем с пациентами на всех стадиях зависимости, включая тяжелые случаи. Наши специалисты имеют опыт лечения даже самых сложных ситуаций.",
      keywords: ["тяжелые случаи", "стадии зависимости", "сложные ситуации"]
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <FAQ 
        items={faqItems}
        title="Часто задаваемые вопросы о клинике"
        description="Ответы на популярные вопросы о нашей клинике, специалистах и методах работы"
      ...
      <InternalLinking 
        keywords={["клиника Мастерская", "лечение зависимостей", "специалисты", "опыт работы"]}
        category="О клинике"
        title="Полезные ссылки"
        maxLinks={6}
      />

      {/* MetaOptimizer Component (только для разработки) */}
      <MetaOptimizer 
