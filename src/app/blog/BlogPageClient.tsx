...
export default function BlogPageClient() {
  ...
  // FAQ данные для страницы блога
  const faqItems = [
    {
      question: "Как часто обновляется блог?",
      answer: "Мы регулярно публикуем новые статьи о лечении зависимостей, профилактике и восстановлении. Новые материалы появляются еженедельно, а также мы обновляем существующие статьи актуальной информацией.",
      keywords: ["обновление блога", "новые статьи", "актуальная информация", "регулярность"]
    },
    {
      question: "Можно ли использовать информацию из блога для самолечения?",
      answer: "Информация в блоге предназначена только для ознакомления и не заменяет консультацию специалиста. Для получения квалифицированной помощи обязательно обратитесь к врачу.",
      keywords: ["самолечение", "консультация врача", "квалифицированная помощь", "информация"]
    },
    {
      question: "Кто пишет статьи для блога?",
      answer: "Статьи пишут наши опытные специалисты: врачи-наркологи, психотерапевты, психологи. Все материалы проходят проверку и основаны на научных исследованиях и практическом опыте.",
      keywords: ["авторы статей", "специалисты", "врачи", "научные исследования"]
    },
    {
      question: "Можно ли задать вопрос по статье?",
      answer: "Да, вы можете задать вопросы по любой статье, связавшись с нами через форму на сайте или по телефону. Наши специалисты с удовольствием ответят на ваши вопросы.",
      keywords: ["вопросы по статьям", "связь с нами", "консультация", "помощь"]
    },
    {
      question: "Есть ли темы, которые вы не освещаете в блоге?",
      answer: "Мы освещаем все аспекты лечения зависимостей, но избегаем тем, которые могут навредить читателям. Наш фокус - на безопасных, научно обоснованных методах лечения и профилактики.",
      keywords: ["темы блога", "безопасность", "научные методы", "профилактика"]
    },
    {
      question: "Как подписаться на новые статьи?",
      answer: "Чтобы не пропустить новые статьи, регулярно посещайте наш блог или свяжитесь с нами для получения уведомлений о новых публикациях по интересующим вас темам.",
      keywords: ["подписка на статьи", "новые публикации", "уведомления", "обновления"]
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <FAQ 
        items={faqItems}
        title="Часто задаваемые вопросы о блоге"
        description="Ответы на популярные вопросы о нашем блоге и статьях"
      ...
      <InternalLinking 
        keywords={["блог", "статьи", "лечение зависимостей", "детоксикация", "психотерапия"]}
        category="Блог"
