...
export default function ServicesPageClient() {
  ...
  // FAQ данные для страницы услуг
  const faqItems = [
    {
      question: "Сколько длится лечение зависимости?",
      answer: "Длительность лечения зависит от индивидуальных особенностей пациента и стадии зависимости. Обычно курс составляет от 21 до 90 дней, но может быть скорректирован в зависимости от прогресса.",
      keywords: ["лечение зависимости", "длительность", "курс лечения"]
    },
    {
      question: "Гарантирована ли анонимность лечения?",
      answer: "Да, мы гарантируем полную анонимность. Все данные пациента строго конфиденциальны и не передаются третьим лицам. Это один из основных принципов нашей работы.",
      keywords: ["анонимность", "конфиденциальность", "защита данных"]
    },
    {
      question: "Можно ли лечиться амбулаторно?",
      answer: "Да, мы предлагаем как стационарное, так и амбулаторное лечение в зависимости от состояния пациента. Амбулаторное лечение подходит для легких случаев и постреабилитационной поддержки.",
      keywords: ["амбулаторное лечение", "стационар", "выбор метода"]
    },
    {
      question: "Какие документы нужны для госпитализации?",
      answer: "Для госпитализации достаточно паспорта. Мы не требуем направления от врача или других документов. Все лечение проводится на основе добровольного согласия пациента.",
      keywords: ["документы", "госпитализация", "паспорт"]
    },
    {
      question: "Работаете ли вы с родственниками зависимых?",
      answer: "Да, мы проводим семейную терапию и консультации для родственников зависимых людей. Это важная часть комплексного лечения, которая помогает семье справиться с кризисной ситуацией.",
      keywords: ["семейная терапия", "родственники", "консультации"]
    },
    {
      question: "Есть ли поддержка после завершения лечения?",
      answer: "Да, мы предоставляем постреабилитационную поддержку и группы взаимопомощи для предотвращения рецидивов. Поддержка может длиться от 6 месяцев до года и более.",
      keywords: ["постреабилитационная поддержка", "группы взаимопомощи", "профилактика рецидивов"]
    },
    {
      question: "Какие методы лечения вы используете?",
      answer: "Мы используем современные, научно обоснованные методы лечения: медикаментозную терапию, психотерапию, когнитивно-поведенческую терапию, семейную терапию и другие эффективные подходы.",
      keywords: ["методы лечения", "психотерапия", "медикаментозная терапия"]
    },
    {
      question: "Работаете ли вы круглосуточно?",
      answer: "Да, наша клиника работает круглосуточно без выходных. Это особенно важно для экстренных случаев, когда требуется немедленная помощь при острых состояниях.",
      keywords: ["круглосуточно", "экстренная помощь", "острые состояния"]
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <FAQ 
        ...
        description="Ответы на популярные вопросы о наших услугах и методах лечения зависимостей"
      ...
      <InternalLinking 
        keywords={["лечение зависимостей", "детоксикация", "реабилитация", "психотерапия"]}
        category="Услуги"
